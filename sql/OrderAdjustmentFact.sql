...
HAVING
  SHIPPING_CHARGES IS NOT NULL
  OR SHIPPING_SALES_TAX IS NOT NULL
  OR EXT_SHIP_ADJUSTMENT IS NOT NULL
  OR EXT_PRICE_OVERRIDE IS NOT NULL
  OR EXT_FEES_ADJUSTMENT IS NOT NULL
  OR EXT_REWARDS IS NOT NULL
  OR EXT_TRANS_ADJUSTMENT IS NOT NULL